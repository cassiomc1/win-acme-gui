...
public static partial class LocalizationTable
{
    ...
    [
        ...
        new("DownloadTooltip", "Baixa a versão oficial x64 mais recente e verifica assinatura e SHA-256.",
            "Downloads the latest official x64 release and verifies its signature and SHA-256."),
